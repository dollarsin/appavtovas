...
class AvtovasLocalizationRu extends AvtovasLocalization {
  ...
  @override
  String get processingChildPersonalDataDescription => 'Автовас понимает важность дополнительных мер предосторожности для обеспечения конфиденциальности и безопасности детей при использовании ими услуг, предоставляемых Автовас.\nОбращаем внимание, что в случае оформлении билета на ребенка младше 18 лет, согласие на обработку его персональных данных дает его законный представитель (родитель/опекун) - если Вам меньше 18 лет, не вводите на нашем сайте свои персональные данные без одобрения родителей/опекунов и не пользуйтесь услугами нашего сайта.\nАвтовас сознательно не собирает персональные данные о детях до 18 лет. Если Вы (Пользователь) считаете, что мы непреднамеренно собрали подобную информацию, свяжитесь с нами по электронному адресу it@avtovas.com, чтобы мы получили согласие законного представителя либо удалили эти данные.';

  @override
  String get referenceQuestion1 => 'Как покупать билеты на сайте?';

  @override
  String get referenceQuestion2 => 'Как правильно заполнять реквизиты документов?';

  @override
  String get referenceQuestion3 => 'Что делать после покупки билета на сайте?';

  @override
  String get referenceQuestion4 => 'Обязательно ли регистрироваться на сайте для покупки билета?';

  @override
  String get referenceQuestion5 => 'За сколько дней до отправления начинается продажа билетов?';

  @override
  String get referenceQuestion6 => 'Можно ли купить на сайте льготные билеты?';

  @override
  String get referenceQuestion7 => 'Можно ли приобрести билет на имя другого человека?';

  @override
  String get referenceQuestion8 => 'Можно ли обменять билет на билет с другим временем или датой отправления?';
  ...
  @override
  String get referenceQuestion11 => 'Можно ли исправить данные по пассажиру в билете?';

  @override
  String get referenceQuestion12 => 'Почему нет обратных билетов?';

  @override
  String get referenceQuestion13 => 'Какие правила необходимо соблюдать при перевозке детей?';

  @override
  String get referenceQuestion14 => 'Что значат сокращения \"АВ\", \"АС\" и другие?';
  ...
  @override
  String get referenceQuestion19 => 'Можно ли быть уверенным в предоставлении выбранного места в автобусе?';

  @override
  String get referenceQuestion20 => 'Какое время указывается для отправления и прибытия?';

  @override
  String get referenceQuestion21 => 'Можно ли сесть в автобус на другой остановке?';

  @override
  String get referenceQuestion22 => 'Почему деньги списались, а билета нет?';

  @override
  String get referenceQuestion23 => 'Почему стоимость билета меняется на разных этапах покупки?';
  ...
  @override
  String get referenceAnswer20 => 'Время отправления и прибытия всегда указывается местное, т.е. время в часового пояса соответствующего населенного пункта (пункта отправления или прибытия). Например, рейс Саратов - Москва, отправление указано по саратовскому времени (UTC+4), прибытие по московскому (UTC+3).';
  ...
  @override
  String get returnFivePercent => '- Ранее двух часов до отправления возврат 95% стоимости билета (удержание 5%)';

  @override
  String get returnFiftheenPercent => '- Позднее двух часов до отправления возврат 85% стоимости билета (удержание 15%)';

  @override
  String get returnTwentyFivePercent => '- После отправления (но не позднее чем через 3 часа, а в случае подтверждения опоздания из-за несчастного случая, в течение 3 суток) возврат 75% стоимости билета (удержание 25%)';

  @override
  String get returnTwentyFivePercentExcuse => '- В случае отмены рейса или задержки более чем на час возврат 100% стоимости билета';
