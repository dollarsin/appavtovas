...
import 'trip_horizontal_painter.dart';
    ...
    if (isVertical) {
      ...
      return Row(
        children: [
          ...
          const SizedBox(width: CommonDimensions.none),
          if (maxSize == null)
            Expanded(
              child: CustomPaint(
      ...
      children: [
        Text(
          ...
          style: textTitleLarge?.copyWith(
            ...
            height: AppFonts.sizeFactorMedium,
          ),
        ),
...
final class _SubtitleContainer extends StatelessWidget {
  const _SubtitleContainer({required this.text});
...
final class _Line extends StatelessWidget {
  const _Line({required this.isVertical, this.maxSize});
