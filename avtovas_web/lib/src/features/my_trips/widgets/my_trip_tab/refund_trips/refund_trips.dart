...
class RefundTrips extends StatefulWidget {
  ...
  @override
  State<RefundTrips> createState() => _RefundTripsState();
}

class _RefundTripsState extends State<RefundTrips> {
    ...
    if (widget.trips == null || widget.trips!.isEmpty) {
      return Column(
        children: [
          ...
          Center(
            child: Text(
              'У вас пока нет возвращённых билетов',
